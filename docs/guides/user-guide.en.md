...
- DS builds provide **Scaling** (Off/Aspect/Full) and **Scale Filter**.
...
- Put `gbc_bios.bin` in GameYob's working directory to use **GBC Bios**. The BIOS is optional and not distributed.
