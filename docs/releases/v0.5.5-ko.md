...
- Azahar launch/display regression and available local runtime checks are performed before publishing the final archive.
...
- 최종 압축을 배포하기 전에 Azahar 실행·표시 회귀와 가능한 로컬 런타임 검사를 수행합니다.
